-- Migration: Fix Admin RLS Policies and Function Parameters
-- Created: 2025-02-28
-- Description: Fixes RLS policies for admin views and function parameter order issues

-- =====================================================
-- 1. FIX RLS POLICIES FOR ADMIN VIEWS
-- =====================================================

-- Grant SELECT permissions on admin views to users with admin role
-- The views need proper RLS policies
...
-- =====================================================
-- 2. FIX FUNCTION PARAMETER ORDER ISSUE
-- =====================================================

-- The issue is that when calling RPC with named parameters in JavaScript,
-- Supabase reads them alphabetically, not in the order defined in the function.
-- Solution: Recreate functions to match alphabetical parameter order
...
-- =====================================================
-- 3. ADD MISSING RLS POLICIES FOR USER_PROFILES
-- =====================================================
...
-- =====================================================
-- 4. ENSURE STORAGE POLICIES FOR DOCUMENTS
-- =====================================================
