...
const multiSelectVariants = cva("m-1 transition-all duration-300 ease-in-out", {
	variants: {
		variant: {
			default: "border-foreground/10 text-foreground hover:bg-card/80",
			secondary:
				"border-foreground/10 bg-secondary text-secondary-foreground hover:bg-secondary/80",
			destructive:
				"border-transparent bg-destructive text-destructive-foreground hover:bg-destructive/80",
			inverted: "border-foreground/10 text-foreground bg-white text-black hover:bg-card/80",
		},
		badgeAnimation: {
								...
								<div className="flex justify-between items-center w-full">
									<div
												...
												return (
													<Badge
														...
														className={cn(
															...
															customStyle?.gradient &&
																"text-white text-lg border-transparent",
										...
										{selectedValues.length > responsiveSettings.maxCount && (
											<Badge
												className={cn(
													"bg-transparent text-md text-foreground border-foreground/1 hover:bg-transparent",
													getBadgeAnimationClass(),
													multiSelectVariants({ variant }),
													responsiveSettings.compactMode &&
														"text-xs px-1.5 py-0.5",
									...
									<div className="flex items-center justify-between">
										...
										<Separator
											...
											className="flex min-h-6 h-full bg-gray-600"
										/>
										<ChevronDown
									...
									<CommandGroup>
										<CommandItem
											...
											<div
												...
												aria-hidden="true">
												<CheckIcon className="h-4 w-4 text-black bg-white rounded-[2px]" />
											</div>
											<span>
												(Select All
